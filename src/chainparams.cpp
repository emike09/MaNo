...
{
    const char* pszTimestamp = "It's a bird! It's a plane! It's MANO! 180311";
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetSpacing = 2.0 * 60; // Mano: 2.0 minutes
        ...
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("mano.org", "dnsseed.mano.org"));
        //vSeeds.push_back(CDNSSeedData("manodot.io", "dnsseed.manodot.io"));
        //vSeeds.push_back(CDNSSeedData("manopay.io", "dnsseed.manopay.io"));

        // Mano addresses start
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,73);
        // Mano script addresses start
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,15);
        // Mano private keys start
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("manodot.io",  "testnet-seed.manodot.io"));
        //vSeeds.push_back(CDNSSeedData("masternode.io", "test.dnsseed.masternode.io"));

        // Testnet Mano addresses start
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,117);
        // Testnet Mano script addresses start
...
public:
    CRegTestParams() {
        ...
        // Regtest Mano addresses start
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,141);
        // Regtest Mano script addresses start
