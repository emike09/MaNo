...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\ManoCore
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\ManoCore
    // Mac: ~/Library/Application Support/ManoCore
    // Unix: ~/.manocore
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "ManoCore";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/ManoCore";
#else
    // Unix
    return pathRet / ".manocore";
#endif
#endif
}
