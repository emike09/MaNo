...
git clone https://github.com/manobanana/mano
```
...
```bash
    ...
    From https://github.com/manobanana/mano
...
cd /some/root/path/
git clone https://github.com/manobanana/mano-detached-sigs.git
...
[mano/gitian.sigs](https://github.com/manobanana/gitian.sigs/) repository, or if that's not possible to create a pull
request.
